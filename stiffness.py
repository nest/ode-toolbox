...
def check_ode_system_for_stiffness(odes_and_function_variables, default_values, threshold_body, reset_statement):
    # Process input
...
def parse_input_parameters(function_variable_definitions, function_variables, ode_definitions,
                           odes_and_function_variables, state_variables):
