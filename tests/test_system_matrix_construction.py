...
class TestSystemMatrixConstruction(unittest.TestCase):
    ...
    def test_system_matrix_construction(self):
        ...
        shapes = from_json_to_shapes(indict, default_config)
    ...
    def test_morris_lecar(self):
        ...
        print(shape_sys.C_)
        print("C ref")
        print(sympy.Matrix([[500.0*E_Ca*g_Ca*sympy.tanh(V/15 + 1/15)/C_m + 500.0*E_Ca*g_Ca/C_m + 1000.0*E_L*g_L/C_m + 1000.0*I_ext/C_m - 1000.0*V*W*g_K/C_m - 500.0*V*g_Ca*sympy.tanh(V/15 + 1/15)/C_m], \
